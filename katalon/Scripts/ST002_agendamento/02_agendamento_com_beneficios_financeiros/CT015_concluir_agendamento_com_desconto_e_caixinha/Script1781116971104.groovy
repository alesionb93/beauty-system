...
assert atendimento.contains('70')
assert caixinhaResumo.contains('10')
assert totalResumo.contains('80')
...
String descontoResumo = WebUI.getText(
...
println('DESCONTO = ' + descontoResumo)
println('TOTAL = ' + totalPagamento)

assert subtotal.contains('80')
assert descontoResumo.contains('10')
assert totalPagamento.contains('80')
...
assert WebUI.getAttribute(ticketObj,'innerText').contains('80')

assert WebUI.getAttribute(faturamentoObj,'innerText').contains('80')

assert WebUI.getAttribute(recebidoObj,'innerText').contains('80')
...
assert totalReceber.contains('45')
...
println('CT015 concluído com sucesso.')