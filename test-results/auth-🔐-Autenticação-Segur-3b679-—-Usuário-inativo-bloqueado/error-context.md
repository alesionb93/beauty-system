...
- Name: auth.spec.js >> 🔐 Autenticação & Segurança >> TC-AUTH-03 — Usuário inativo bloqueado
- Location: tests\auth.spec.js:35:7
...
Locator: locator('text=/inativo|bloquead|contate/i').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=/inativo|bloquead|contate/i').first()
